...
export default function ProductBanner() {
    return (
        <div
            className="relative w-full h-32 md:h-40 rounded-lg overflow-hidden bg-cover bg-center"
            style={{
                backgroundImage: "url('/sliderImage.svg')", // ✅ reference directly from /public
            }}
