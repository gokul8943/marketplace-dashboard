    ...
    <div className="w-full bg-gray-100 py-12 px-4">
      <div className="max-w-6xl mx-auto  bg-white rounded-lg p-8">
        ...
        <div className="relative flex items-center justify-center">
          ...
          <div className="grid grid-cols-5 gap-4 mx-12 w-full max-w-4xl">
            {visibleClients.map((client, index) => (
              ...
              >
                <div className="text-center px-4">
                  ...
                  {client.name === 'Amentum' && (
                    <div className="text-lg font-semibold text-gray-700">amentum</div>
                  )}
                  {client.name === 'Daikin' && (
                    <div className="text-lg font-bold text-gray-600 tracking-wider">DAIKIN</div>
                  )}
                  {client.name === 'GE' && (
                  ...
                  {client.name === 'Airwheel' && (
                    <div className="text-lg font-medium text-gray-600">Airwheel</div>
                  )}
                  {client.name === 'Microsoft' && (
                    <div className="text-lg font-semibold text-blue-600">Microsoft</div>
                  )}
                  {client.name === 'Amazon' && (
